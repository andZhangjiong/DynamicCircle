...
//        [self startAnimate];
    ...
    [self performSelector:@selector(animationgStop) withObject:nil afterDelay:animation.duration];
    
}

-(void)animationgStop{
    if (self.explodeStopBlock) {
        self.explodeStopBlock();
    }
}
